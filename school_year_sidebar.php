     <div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
						...
						<li>
                            <a href="subjects.php"><i class="icon-chevron-right"></i><i class="icon-list-alt"></i> Tasks</a>
                        </li>
						<li>
                            <a href="class.php"><i class="icon-chevron-right"></i><i class="icon-group"></i> Team</a>
                        </li>
						<li  class="">
						...
						<li>
                            <a href="students.php"><i class="icon-chevron-right"></i><i class="icon-group"></i> Members</a>
                        </li>
						<li>
                            <a href="teachers.php"><i class="icon-chevron-right"></i><i class="icon-group"></i> Coach</a>
                        </li>
							<li>
						...
						<li class="active">
                            <a href="school_year.php"><i class="icon-chevron-right"></i><i class="icon-calendar"></i> Traininjg Year</a>
                        </li>
						<li class="">
